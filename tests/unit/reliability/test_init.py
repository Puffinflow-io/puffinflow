...
class TestReliabilityModuleImports:
    ...
    def test_bulkhead_imports(self):
        ...
        from puffinflow.core.reliability import (
            Bulkhead, BulkheadFullError, BulkheadConfig
        )
    ...
    def test_no_unexpected_exports(self):
        ...
        public_attrs = [attr for attr in dir(puffinflow.core.reliability) 
...
class TestReliabilityImportPaths:
    ...
    def test_circuit_breaker_import_path(self):
        ...
        assert hasattr(puffinflow.core.reliability.circuit_breaker, 'CircuitBreakerError')
        assert hasattr(puffinflow.core.reliability.circuit_breaker, 'CircuitBreakerConfig')
    ...
    def test_leak_detector_import_path(self):
        ...
        assert hasattr(puffinflow.core.reliability.leak_detector, 'ResourceLeakDetector')
...
class TestReliabilityPatterns:
    ...
    def test_circuit_breaker_pattern_exports(self):
        ...
        expected_circuit_items = ['CircuitBreaker', 'CircuitBreakerConfig', 'CircuitState', 'CircuitBreakerError']
    ...
    def test_reliability_patterns_coverage(self):
        ...
        for pattern, present in patterns.items():
            assert present, f"Reliability pattern '{pattern}' not represented in exports"