...
class TestBufferedEventProcessor:
    ...
    def test_buffered_event_processor_creation(self):
        ...
        config = EventsConfig(enabled=True, buffer_size=100, batch_size=10, flush_interval=1.0)
    ...
    async def test_process_loop_general_exception(self):
        ...
        with patch('asyncio.sleep', side_effect=mock_sleep):
            with patch('builtins.print') as mock_print:
                ...
                # Check that error was printed
                mock_print.assert_called_with("Event processing loop error: General error")