...
from src.puffinflow.core.observability.interfaces import SpanType, ObservabilityEvent
...
class TestObservableContext:
    ...
    def test_trace_with_observability(self):
        ...
        mock_tracing.span.assert_called_once_with("test_span", SpanType.BUSINESS, **expected_attrs)

    def test_trace_with_missing_context_variables(self):
        """Test trace method with missing context variables"""
        shared_state = {"agent_name": "test_agent"}  # Missing workflow_id and current_state
    ...
    def test_metric_with_observability(self):
        ...
        observability.histogram.assert_called_once_with("test_metric", labels=expected_labels)
    ...
    def test_log_event_structure(self):
        ...
        if captured_event:
            assert captured_event.timestamp == 1234567890.0
