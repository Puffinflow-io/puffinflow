...
class TestPrometheusMetric:
    ...
    def test_record_counter_with_labels(self):
        ...
        mock_prometheus_metric.labels.assert_called_once_with(label1="value1", label2="value2")
...
class TestPrometheusMetricsProvider:
    ...
    def test_counter_creation(self, mock_counter_class):
        ...
        metric = provider.counter("requests_total", "Total requests", ["method", "status"])
    ...
    def test_histogram_creation(self, mock_histogram_class):
        ...
        metric = provider.histogram("request_duration", "Request duration", ["endpoint"])
    ...
    def test_metric_with_no_labels(self):
        ...
        with patch('src.puffinflow.core.observability.metrics.PrometheusCounter') as mock_counter:
            ...
            metric = provider.counter("simple_counter")
    ...
    def test_thread_safety(self):
        ...
        metric_names = [f"test_metric_{i}" for i in range(10)]
