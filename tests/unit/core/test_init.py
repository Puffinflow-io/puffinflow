...
import pytest
from src.puffinflow.core import __init__
...
class TestCoreInit:
    ...
    def test_core_submodules_importable(self):
        ...
        from src.puffinflow.core import config
        from src.puffinflow.core import agent
        from src.puffinflow.core import coordination
        from src.puffinflow.core import observability
        from src.puffinflow.core import reliability
        from src.puffinflow.core import resources
