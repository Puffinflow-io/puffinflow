...
class TestBasicDecoratorFunctionality:
    ...
    def test_state_decorator_no_params(self):
        ...
        # No resource requirements when none explicitly specified
...
class TestResourceRequirements:
    ...
    def test_priority_mapping(self):
        ...
        for priority_input, expected_priority in test_cases:

            @state(priority=priority_input)
            async def priority_state(context: Context):
                return "done"

            assert priority_state._priority == expected_priority
            # No resource requirements when only priority specified
