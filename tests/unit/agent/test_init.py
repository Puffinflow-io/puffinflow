...
from src.puffinflow.core.agent import (
    # Core classes
    Agent, AgentResult, Context, AgentCheckpoint, ResourceTimeoutError,
    # State management
    Priority, AgentStatus, StateStatus, StateMetadata,
    PrioritizedState, RetryPolicy, DeadLetter, StateResult, StateType,
    # Dependencies
    DependencyType, DependencyLifecycle, DependencyConfig,
    # Team decorators
    create_team_decorator, create_environment_decorator, create_service_decorator,
    create_reliable_team_decorator, create_external_team_decorator
)
...
class TestTeamDecorators:
    ...
    def test_create_team_decorator_with_decorators_available(self):
        ...
        with patch('src.puffinflow.core.agent.decorators.flexible.create_custom_decorator') as mock_create:
            mock_decorator = Mock()
    ...
    def test_create_team_decorator_without_decorators(self):
        ...
        with patch('src.puffinflow.core.agent.decorators.flexible.create_custom_decorator', side_effect=ImportError):
...
class TestConvenienceDecorators:
    ...
    def test_team_decorator_with_multiple_parameters(self):
        ...
        with patch('src.puffinflow.core.agent.decorators.flexible.create_custom_decorator') as mock_create:
            ...
            decorator = create_team_decorator(
                "data-team",
                cpu=4.0,
                memory=2048.0,
                priority="high",
    ...
    def test_environment_decorator_with_custom_description(self):
        ...
        with patch('src.puffinflow.core.agent.decorators.flexible.create_custom_decorator') as mock_create:
            ...
            decorator = create_environment_decorator(
                "staging",
                description="Custom staging environment agent",
                retries=3
            )
    ...
    def test_reliable_team_decorator_overrides_defaults(self):
        ...
        with patch('src.puffinflow.core.agent.decorators.flexible.create_custom_decorator') as mock_create:
            ...
            decorator = create_reliable_team_decorator(
                "critical-team",
    ...
    def test_external_team_decorator_timeout_override(self):
        ...
        with patch('src.puffinflow.core.agent.decorators.flexible.create_custom_decorator') as mock_create:
            ...
            decorator = create_external_team_decorator(
                "external-api",
