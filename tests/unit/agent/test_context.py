...
class TestContextInitialization:
    ...
    def test_context_basic_initialization(self):
        ...
        # Lazily initialized — None until first use
        assert context._typed_data is None
        assert context._typed_var_types is None
        assert context._validated_types is None
