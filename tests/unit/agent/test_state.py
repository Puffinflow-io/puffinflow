...
from puffinflow.core.agent.state import (
    Priority, AgentStatus, StateStatus, StateFunction, RetryPolicy,
    DeadLetter, StateMetadata, PrioritizedState, StateResult
)
...
class TestIntegration:
    ...
    def test_prioritized_state_queue_behavior(self):
        ...
        for i, priority in enumerate([Priority.LOW, Priority.CRITICAL, Priority.NORMAL, Priority.HIGH]):
