...
class TestInputType:
    ...
    def test_input_type_members(self):
        ...
        expected_members = {
            'VARIABLE', 'SECRET', 'CONSTANT', 'CACHED', 'TYPED', 'OUTPUT'
        }
...
class TestScheduledInput:
    ...
    def test_apply_to_context_cached(self):
        ...
        context = Mock()
        input_obj = ScheduledInput("cache_key", "cache_value", InputType.CACHED, ttl=600)
    ...
    def test_apply_to_context_typed(self):
        ...
        context.set_typed_variable.assert_called_once_with("typed_key", {"data": "value"})
...
class TestParseInputs:
    ...
    def test_parse_inputs_mixed_types(self):
        ...
        for key in ["int_val", "float_val", "bool_val", "list_val", "dict_val", "none_val"]:
