...
from puffinflow.core.agent.scheduling.inputs import ScheduledInput, InputType
...
class TestScheduledAgent:
    ...
    @patch('puffinflow.core.agent.scheduling.scheduler.GlobalScheduler.get_instance_sync')
...
class TestGlobalScheduler:
    ...
    def test_schedule_agent(self, mock_parse_inputs, mock_parse_schedule):
        ...
        job_id = list(self.scheduler._jobs.keys())[0]
    ...
    def test_get_scheduled_jobs_with_jobs(self):
        ...
        job1 = ScheduledJob(
            ...
            schedule=ParsedSchedule("interval", interval_seconds=300, description="Every 5 minutes"),
            inputs={},
            next_run=time.time() + 300,
            last_run=time.time() - 100,
            run_count=3
        ...
        job2 = ScheduledJob(
            ...
            schedule=ParsedSchedule("cron", cron_expression="0 * * * *", description="Every hour"),
            inputs={},
