...
class TestScheduleBuilder:
    ...
    def test_with_inputs_chaining(self):
        ...
        result = (self.builder
                 .with_inputs(key1="value1")
                 .with_inputs(key2="value2"))
    ...
    def test_with_typed_multiple(self):
        ...
        result = self.builder.with_typed(
            count=42,
            rate=3.14
        )
    ...
    def test_with_outputs_multiple(self):
        ...
        result = self.builder.with_outputs(
            status="completed",
    ...
    def test_mixed_input_types_same_key(self):
        ...
        (self.builder
         .with_inputs(key="variable")
         .with_secrets(key="secret"))
...
class TestScheduleBuilderEdgeCases:
    ...
    def test_empty_inputs_methods(self):
        ...
        assert all(r is self.builder for r in [result1, result2, result3, result4, result5, result6])
        assert len(self.builder._inputs) == 0
    
    def test_none_values(self):
        """Test handling None values in inputs."""
        result = (self.builder
                 .with_inputs(none_var=None)
        ...
        for key, scheduled_input in self.builder._inputs.items():
    ...
    def test_special_characters_in_keys(self):
        ...
        for key in ["key-with-dashes", "key_with_underscores", "key.with.dots", "key with spaces"]:
            assert key in self.builder._inputs
