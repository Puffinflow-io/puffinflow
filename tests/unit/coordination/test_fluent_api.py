...
class TestAgents:
    ...
    async def test_run_parallel(self):
        ...
        with patch('src.puffinflow.core.coordination.fluent_api.AgentTeam') as mock_team_class:
            mock_team = Mock()
...
class TestPipelineAgents:
    ...
    async def test_pipeline_run(self):
        ...
        with patch('src.puffinflow.core.coordination.fluent_api.TeamResult') as mock_team_result_class:
            with patch('src.puffinflow.core.coordination.fluent_api.FluentResult') as mock_fluent_result_class:
...
class TestHelperFunctions:
    ...
    async def test_run_parallel_agents(self):
        ...
        with patch('src.puffinflow.core.coordination.fluent_api.Agents') as mock_agents_class:
            ...
            mock_agents_instance.run_parallel = AsyncMock(return_value=mock_fluent_result)
    ...
    async def test_run_sequential_agents(self):
        ...
        with patch('src.puffinflow.core.coordination.fluent_api.Agents') as mock_agents_class:
            ...
            # Create a mock FluentResult
            mock_fluent_result = Mock()
            mock_agents_instance.run_sequential = AsyncMock(return_value=mock_fluent_result)
    ...
    async def test_collect_agent_outputs(self):
        ...
        with patch('src.puffinflow.core.coordination.fluent_api.Agents') as mock_agents_class:
            ...
            mock_agents_class.return_value = mock_agents_instance
            mock_agents_instance.add_many = Mock(return_value=mock_agents_instance)
            mock_agents_instance.collect_outputs = AsyncMock(return_value=["output1", "output2"])
...
class TestAgentsAdvanced:
    ...
    async def test_run_with_coordination(self):
        ...
        with patch('src.puffinflow.core.coordination.fluent_api.AgentOrchestrator') as mock_orchestrator_class:
            ...
            mock_orchestrator.set_global_variable.assert_called_with("global_var", "global_value")
    ...
    async def test_aggregate_stage_results(self):
        ...
        with patch.object(agents, 'run_with_coordination') as mock_run_coordination:
            ...
            mock_stage_result.get_all_outputs = Mock(return_value=["result1", "result2"])
...
class TestConditionalAgentsAdvanced:
    ...
    def test_conditional_full_workflow(self):
        ...
        parent = Agents()
        conditional = ConditionalAgents(parent, "condition_agent", "output_key", "expected")
    ...
    async def test_pipeline_run_with_piping(self):
        ...
        with patch('src.puffinflow.core.coordination.fluent_api.TeamResult') as mock_team_result_class:
            with patch('src.puffinflow.core.coordination.fluent_api.FluentResult') as mock_fluent_result_class:
                ...
                mock_agent2.set_variable.assert_called_once_with("input_key", "piped_value")
...
class TestHelperFunctionsAdvanced:
    ...
    async def test_get_best_agent_minimize(self):
        ...
        with patch('src.puffinflow.core.coordination.fluent_api.Agents') as mock_agents_class:
            ...
            mock_agents_instance.get_best_by.assert_called_once_with("error_rate", False)
