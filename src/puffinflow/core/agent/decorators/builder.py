...
class StateBuilder:
    ...
    def circuit_breaker(self, enabled: bool = True, failure_threshold: int = 5,
                       recovery_timeout: float = 60.0, success_threshold: int = 3) -> 'StateBuilder':
    ...
    def protected(self, failure_threshold: int = 3, recovery_timeout: float = 30.0) -> 'StateBuilder':
    ...
    def fragile(self, failure_threshold: int = 2, recovery_timeout: float = 120.0) -> 'StateBuilder':
        """Enable circuit breaker for fragile operations (low threshold, long recovery)"""
        return self.circuit_breaker(True, failure_threshold, recovery_timeout)

    # NEW: Bulkhead methods
    def bulkhead(self, enabled: bool = True, max_concurrent: int = 5,
                max_queue_size: int = 100, timeout: float = 30.0) -> 'StateBuilder':
    ...
    def fault_tolerant(self, circuit_breaker: bool = True, bulkhead: bool = True,
                      max_concurrent: int = 3, failure_threshold: int = 3) -> 'StateBuilder':
    ...
    def production_ready(self) -> 'StateBuilder':
        ...
        return (self
                .circuit_breaker(True, failure_threshold=5, recovery_timeout=60.0)
    ...
    def external_call(self, timeout: float = 30.0) -> 'StateBuilder':
        ...
        return (self
                .circuit_breaker(True, failure_threshold=2, recovery_timeout=30.0)
